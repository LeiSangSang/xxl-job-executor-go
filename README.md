...
import (
	"context"
	"fmt"
	xxl "github.com/LeiSangSang/xxl-job-executor-go"
	"github.com/LeiSangSang/xxl-job-executor-go/example/task"
	"log"
)
...
```
# 示例项目
github.com/LeiSangSang/xxl-job-executor-go/example/
# 与gin框架集成
